...
This project includes the "rails engine":rails-engine, "GTFS Engine":gtfs-engine. This engine is mounted at @/gtfs@ and provides all its actions under that directory. For example, to fetch all the stops for the @halifax@ data source, the path would be:

bc. /gtfs/halifax/stops
